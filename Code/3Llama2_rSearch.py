...
history_file_path = "../Laama2_RunHistory_LoRA_rSearch.csv"
...
#RQ2: Identify "r" 
list_LORA_TARGET_MODULES = [["q_proj","v_proj","k_proj", "o_proj"],["q_proj"],["q_proj","k_proj"]] #qk because RQ1 results show so
list_lora_r = [1,2,4,8,16,32,64,128] #256-Out-of-mem
for LORA_TARGET_MODULES in list_LORA_TARGET_MODULES:
    for lora_r in list_lora_r:
        print("\n\n----------------------------------------------------------------------")
        ...
        weight_matrices = ''.join([module[0] for module in LORA_TARGET_MODULES])
        adapter_dir = output_dir+'RQ2/Ada_W'+weight_matrices+'_r'+str(lora_r)+'/'
